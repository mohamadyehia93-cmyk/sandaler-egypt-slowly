    ...
    <div className="min-h-screen bg-surface pb-8">
      <header className="sticky top-0 z-40 bg-background border-b border-border">
        ...
        <p className="px-4 pb-2 text-xs text-muted-foreground leading-relaxed">
          {lang === "ar"
            ? "أشخاص اختارتهم سندال وأدرجتهم في الدليل. لو مدرَج هنا، يمكنك استلام ملفك."
            : "People Sandal has recognised and listed. If you're listed here, you can claim your profile."}
        </p>
