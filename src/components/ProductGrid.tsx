        ...
        {isLoading ? (
          ...
          <div key={p.id} className="rounded-lg overflow-hidden shadow-card bg-card">
            <div className="relative h-32">
              <img src={p.image || "/placeholder.svg"} alt={lang === "ar" ? (p.name_ar || p.name_en) : p.name_en} className="w-full h-full object-cover" />
              ...
              {p.seller_name_en && (
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="text-[9px] text-primary font-medium truncate">
                    {lang === "ar" ? (p.seller_name_ar || p.seller_name_en) : p.seller_name_en}
                  </span>
                </div>
              )}
